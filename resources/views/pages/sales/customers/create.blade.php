                    ...
                    <form action="{{ route('customer.create') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 mt-2">
                                    <div class="icheck-success d-inline">
                                        <input type="radio" id="c27" name="organization" value="0" required
                                            checked>
                                        <label class="label_values" for="c27"
                                            style="margin-right: 15px;">Business</label>
                                    </div>
                                    <div class="icheck-danger d-inline">
                                        <input type="radio" id="c28" name="organization" value="1">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-10 d-flex">
                                    <select class="custom-select rounded-0 w-25" name="resident_country"
                                        style="border-radius: 5px; " required>
                                        <option selected value="">--Select Resident Country--</option>
                                        @foreach ($countries as $countryItems)
                                            <option value="{{ $countryItems->id }}">{{ $countryItems->country_name }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="card-header" style="background: #222e3c">
                            <span class="card-title mb-0 d-flex justify-content-between">
                                <h4 style="color: #e9ecef">{{ __('Additional Details') }}</h4>
                            </span>
                        </div>
                        <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8 d-flex">
                                                                        <select name="billing_country_region"
                                                                            ...
                                                                            @foreach ($countries as $countryItems)
                                                                                <option value="{{ $countryItems->id }}">
                                                                                    {{ $countryItems->country_name }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8 d-flex">
                                                                        <textarea class="form-control rounded-0" id="exampleFormControlTextarea1" rows="3" placeholder="Street 1"
                                                                            name="billing_street_1" style="width: 75%; font-size: 10px;"></textarea>

                                                                    </div>
                                                                    <label class="col-sm-4 col-form-label"></label>
                                                                    <div class="col-sm-8 d-flex">
                                                                        <textarea class="form-control mt-2 rounded-0" id="exampleFormControlTextarea1" rows="3" placeholder="Street 2"
                                                                            name="billing_street_2" style="width: 75%; font-size: 10px;"></textarea>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-8 d-flex">
                                                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Street 1"
                                                                            name="shipping_street_1" style="width: 75%; font-size: 10px;"></textarea>

                                                                    </div>
                                                                    <label class="col-sm-4 col-form-label"></label>
                                                                    <div class="col-sm-8 d-flex">
                                                                        <textarea class="form-control mt-2" id="exampleFormControlTextarea1" rows="3" placeholder="Street 2"
                                                                            name="shipping_street_2" style="width: 75%; font-size: 10px;"></textarea>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <label class="col-sm-2 col-form-label">Whatsapp
                                                        Number</label>
                                                    <div class="col-sm-10 d-flex">
                                                        <input type="whatsapp_number" class="form-control w-25 rounded-0"
...
@push('scripts')
    <script>
        ...
        function addItem() {
            ...
            html += "<td>" + items + "</td>";
            html +=
                '<td> <select class="custom-select rounded-0" name="salutation" style="border-radius: 5px;" required><option selected>--Select Salutaion--</option><option value="0">MR</option><option value="1">MRS</option><option value="2">MS</option><option value="3">MSS</option></select></td>';
            html +=
                '<td><input type="text" name="first_name[]" class="form-control rounded-0" required /></td>';
            html +=
                '<td><input type="text" name="last_name[]" class="form-control rounded-0" required /></td>';
            html +=
                '<td><input type="text" name="email[]" class="form-control rounded-0" required /></td>';
            html +=
                '<td><input type="text" name="work_phone[]" class="form-control rounded-0" required /></td>';
            html +=
                '<td><input type="text" name="mobile[]" class="form-control rounded-0" required /></td>';
            html +=
