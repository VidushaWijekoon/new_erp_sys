            ...
            <div class="card">
                <div class="card-header" style="background: #222e3c">
                    <span class="card-title mb-0 d-flex justify-content-between">
                        <h4 style="color: #e9ecef" class="text-capitalize">{{ $departments->department_name }}</h4>
                    </span>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="password" class="form-control rounded-0" name="description" placeholder="Description" rows="3">{{ $departments->description }} </textarea>
                                    @error('description')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
