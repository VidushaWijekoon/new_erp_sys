        ...
        <div class="d-flex justify-content-between">
            <div class="row mb-2 mb-xl-3">
                <div class="col-auto d-none d-sm-block">
                    <h3><strong class="mx-1">{{ __('HRM') }}</strong> {{ __('Attendance') }}
                        <strong>{{ __('2023-September') }}</strong>
                    </h3>
                </div>
            </div>
            <div class="row mb-2 mb-xl-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="half-day"><span class="first-off"><i
                                                ...
                                                class="first-off"><i class="fa fa-close text-danger"></i></span></div>
                                    </td>
                                    <td><i class="fa fa-check text-success"></i> </td>
                                    <td><i class="fa fa-check text-success"></i> </td>
                                    ...
                                    <td>
                                        <div class="half-day"><span class="first-off"><i
                                                ...
                                                class="first-off"><i class="fa fa-check text-success"></i></span></div>
                                    </td>
                                    <td><i class="fa fa-check text-success"></i> </td>
                                    <td><i class="fa fa-check text-success"></i> </td>
                                    <td><i class="fa fa-close text-danger"></i> </td>
