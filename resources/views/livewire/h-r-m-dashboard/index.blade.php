                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="d-flex align-items-center" style="text-align: end">
                                            Organize all employees, Department and Designation.
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="card border-success">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="d-flex align-items-center" style="text-align: end">
                                            Manage employee payroll, leaves, attendance
                                        </span>
                                    </div>
                                </div>
                                <div class="card-footer border-danger" style="border-top: 1px solid blue">
                            ...
                            <div class="card border-success">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="d-flex align-items-center" style="text-align: end">
                                            Check all the employee monthly, weekly, daily perfomance
                                        </span>
                                    </div>
                                </div>
                                <div class="card-footer border-danger" style="border-top: 1px solid blue">
                            ...
                            <div class="card border-success">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <span class="d-flex align-items-center" style="text-align: end">
                                            Check and use data for reporting and compliance purposes,Follow all
