    ...
    <div class="container-fluid p-0">
        <div class="row mb-2 mb-xl-3">
            <div class="col-auto d-none d-sm-block">
                <h3><strong>{{ __('Accounts') }}</strong> {{ __('Dashboard') }}</h3>
            </div>
        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="card border-success">
                                ...
                                <div class="card-footer border-danger" style="border-top: 1px solid blue">
                                    <div class="d-flex justify-content-between">
                                        <strong>
                                            <h4>3 : <span>Sales Orders</span></h4>
                                        </strong>
                        ...
                        <div class="col-md-3">
                            <div class="card border-success">
                                ...
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <i class="fa-solid fa-file-invoice-dollar fa-4x mt-1 p-3 text-secondary"></i>
                                        <span class="d-flex align-items-center" style="text-align: end">
                                            General Ledger, Cash Book, Accounts Receivable, Accounts Payable, VAT
                                            Register, credit, debit notes, all accounts terms
                                        </span>
                                    </div>
                                </div>
                                <div class="card-footer border-danger" style="border-top: 1px solid blue">
